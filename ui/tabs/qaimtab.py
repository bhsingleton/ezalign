...
class QAimTab(qabstracttab.QAbstractTab):
    ...
    def __setup_ui__(self, *args, **kwargs):
        ...
        self.worldUpObjectLabel.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed))
        self.worldUpObjectLabel.setFixedSize(QtCore.QSize(40, 24))
        ...
        self.worldUpObjectLineEdit.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed))
        ...
        self.worldUpObjectPushButton.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed))
        self.worldUpObjectPushButton.setFixedSize(QtCore.QSize(60, 24))
